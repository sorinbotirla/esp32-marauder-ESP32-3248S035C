...
void CommandLine::runCommand(String input) {
  ...
  // LED command
    ...
    int pat_arg = this->argSearch(&cmd_args, "-p");
      ...
      if (hex_arg != -1) {
        ...
        } else if (pat_name == "attackwifi") {
          led_obj.setMode(MODE_ATTACK_WIFI);
        } else if (pat_name == "sniffwifi") {
          led_obj.setMode(MODE_SNIFF_WIFI);
        } else if (pat_name == "scanwifi") {
          led_obj.setMode(MODE_SCAN_WIFI);
        } else if (pat_name == "servewifi") {
          led_obj.setMode(MODE_SERVE_WIFI);
        } else if (pat_name == "attackbt") {
          led_obj.setMode(MODE_ATTACK_BT);
        } else if (pat_name == "sniffbt") {
          led_obj.setMode(MODE_SNIFF_BT);
        } else if (pat_name == "scanbt") {
          led_obj.setMode(MODE_SCAN_BT);
        } else if (pat_name == "kitt" || pat_name == "gpskitt") {
          led_obj.setMode(MODE_GPS_KITT);
        } else if (pat_name == "gpsnofix") {
          led_obj.setMode(MODE_GPS_NOFIX);
        } else if (pat_name == "gpsfix") {
          led_obj.setMode(MODE_GPS_FIX);
        } else if (pat_name == "rasta") {
          led_obj.setMode(MODE_RASTA);
        } 
      }
    #else
  ...
  // LEDS OFF command
  else if (cmd_args.get(0) == LEDS_OFF_CMD) {
    #ifdef PIN
