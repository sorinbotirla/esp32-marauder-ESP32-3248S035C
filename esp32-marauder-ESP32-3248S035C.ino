...
void setup()
{
  ...
  #ifdef HAS_SCREEN
    #ifdef MARAUDER_MINI
      display_obj.drawJpeg("/bootimg.jpg", 0 , 0);     // 240 x 320 image
      display_obj.tft.drawCentreString(display_obj.version_number, 120, 250, 2);
    #else
      display_obj.drawJpeg("/bootimg.jpg", 40, 80);  // left px , top px  // 240 x 320 image on 320x480 display
      display_obj.tft.drawCentreString(display_obj.version_number, TFT_WIDTH/2, TFT_HEIGHT * 0.90, 1);
    #endif
  #endif
